...
export class PeopleController {
    ...
    async getAllPeople(
        ...
        let peopleToReturn;
        if (arrangement) {
            peopleToReturn = await this.peopleService.getPeopleWithArrangement(arrangement);
        } else {
    ...
    async updatePerson(
        ...
        return await this.peopleService.updatePerson(id, name, description, location, index, published, image, arrangement);
    }
